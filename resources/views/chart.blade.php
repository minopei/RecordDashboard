...
@section('content')
    <div class="container">
        ...
        <div class="row">
            <div class="col-6 mb-2" id="container"></div>
            <div class="col-6 mb-2" id="container1"></div>
        </div>
        <div class="row">
    ...
    <script>
        ...
        let groupedAllByState = groupBy(processStateData, 'state');
        ...
        function StateinRange() {
            ...
            let dateInRangeState = processStateData.filter(processStateData1 => newEndDate > processStateData1.date);
            let dateInRangeState1 = dateInRangeState.filter(dateInRange1 => dateInRange1.date > newStartDate);

            return dateInRangeState1;
        }
        ...
        function updateComputerRequest() {
            var dateInRangeState = StateinRange();
            let groupedByState = groupBy(dateInRangeState, 'state');
            let chartState = newJson(groupedByState);
            ...
            AllStateChart.series[0].setData(chartState);
        ...
        var AllStateChart = Highcharts.chart('container1', {
            chart: {
                // backgroundColor: '#f8fafc',
                plotBackgroundColor: null,
                plotBorderWidth: null,
